...
static float ALPHA_GRAV = 0.1f;
constexpr float ON_THRESH = 0.08f;
constexpr float OFF_THRESH = 0.06f;
...
void feedModelAndPrint(float currentRms)
{
  ...
  Serial.print(" | Err: ");
  Serial.println(fabs(currentRms - out_real), 6);
}
